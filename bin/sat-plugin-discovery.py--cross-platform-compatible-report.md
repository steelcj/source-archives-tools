# sat-plugin-discovery.py--cross-platform-compatible-report

**Your script — is cross-platform and will work on Windows, macOS, and Linux — with one critical dependency note.**
