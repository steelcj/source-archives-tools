...
- Then we can flesh out one real plugin (my vote: `taxonomy/para` or `metadata/dublin-core`) so you have an end-to-end “walk the tree and do something real” example.